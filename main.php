        ...
        <a href="#" class="navbar-brand"><img src="img/logo.svg"></a>
            <div class="collspase navbar-collspace">
                <ul class="navbar-nav" style="display: flex; margin-top: 0px;">
                    ...
                    <li class="nav-item" style="list-style-type: none;">
                        <a href="registr/register.php" class="nav-link" style="text-decoration: none; color: #000; font-weight: 500; font-size: 20px; margin-left: 40px;">Зарегистрироваться</a>
                    </li>
                    <li class="nav-item" style="list-style-type: none;">
                        <a href="registr/login.php" class="nav-link" style="text-decoration: none; color: #000; font-weight: 500; font-size: 20px; margin-left: 40px;">Войти</a>
                    </li>
                </ul>
            </div>
        </div>
